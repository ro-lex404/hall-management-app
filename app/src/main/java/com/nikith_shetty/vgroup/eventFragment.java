...
import adapters.RVAdapter_bookings;
...
public class eventFragment extends Fragment{
    ...
    RecyclerView rv;
    RVAdapter_bookings rvAdapterBookings;
    Reader reader;
    Gson gson = new Gson();
    ...
    public void onResume() {
        super.onResume();
        appTitleInterface.onSetTitle("Bookings");
        if(context != null) {
    ...
    private void setUpView() {
        ...
        rvAdapterBookings = new RVAdapter_bookings(eventDataList);
        rvAdapterBookings.setListener(new RVAdapter_bookings.Listener() {
            @Override
        ...
        rv.setAdapter(rvAdapterBookings);
